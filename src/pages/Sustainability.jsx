...
const Sustainability = () => {
  return (
    <div  data-aos="fade-right" data-aos-delay="400" className="w-full">
      ...
      <div className="flex w-full justify-between p-2 flex-wrap">
        <div style={{ width: '45%' }} className=" abt flex flex-col gap-8 items- p-2 justify-center">
          <h1 className="text-red-600 texxl">Overview</h1>
          <h6>We recognise the importance of operating in a sustainable manner, thus meeting the needs of today without jeopardising our ability to meet the needs of tomorrow.</h6>
       <p className="mt-4">The Board assumes ultimate responsibility for sustainability, however management accountability is integral to delivering our sustainability objectives. In line with King IV, sustainability is integrated into both the governance and strategy of WBHO. Full details of our sustainability strategy, approach and implementation can be found in the Environmental, Social and Governance report under the Investor section of the website.</p>
        </div>
        <div style={{ width: '45%' }} className=" abt flex flex-col gap-8 items- justify-center">
          <h4>21Knights sustainability objectives revolve around the following pillars:-</h4>
          <ol>
            <li className="">INNOVATION</li>
            <li>CIVIL & ENERGY INFRASTRACTURE</li>
            <li>SOCIAL & AGRICULTURE INFRASTRACTURE</li>
            <li>SUSTAINABLE WATER SUPPLY & DISTRIBUTION SYSTEMS</li>
            <li>CONSTRUCTION</li>
          </ol>
          <p className="mt-4">The Board assumes ultimate responsibility for sustainability, however management accountability is integral to delivering our sustainability objectives. In line with King IV, sustainability is integrated into both the governance and strategy of WBHO. Full details of our sustainability strategy, approach and implementation can be found in the Environmental, Social and Governance report under the Investor section of the website.</p>
